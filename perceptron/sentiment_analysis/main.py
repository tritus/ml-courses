...
stop_words = utils.load_txt_list('stopwords.txt')
...
for max_it in [10, 20, 50]:
    print("for T=" + str(max_it))
    thetas_perceptron = p1.perceptron(toy_features, toy_labels, max_it)
    thetas_avg_perceptron = p1.average_perceptron(toy_features, toy_labels, max_it)
    thetas_pegasos = p1.pegasos(toy_features, toy_labels, max_it, L)
